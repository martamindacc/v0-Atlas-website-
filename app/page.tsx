export default function Home() {
  return (
    <main style={{ backgroundColor: "#fafafb" }}>
      {/* ── Sticky frosted header wrapper ── */}
      <div className="sticky top-0 z-50 w-full pt-[14px] px-6">
        <header className="max-w-[1280px] mx-auto flex items-center justify-between h-[68px] px-6 rounded-[14px] bg-white/55 supports-[backdrop-filter]:bg-white/55 backdrop-blur-xl backdrop-saturate-150 border border-black/5 shadow-[0_8px_28px_rgba(0,0,0,0.08)]">
          {/* Left — Logo + wordmark */}
          <a href="/" className="flex items-center gap-3">
            ...
            />
            <span className="text-[18px] font-medium tracking-[0.06em] text-neutral-500 uppercase leading-none">
              MINDACC
            </span>
          </a>
          ...
          <div className="flex items-center gap-3">
            {/* Get Started CTA */}
            <button className="flex items-center justify-center border border-black/30 bg-white/80 text-[#1e1f2b] text-[15px] font-medium tracking-tight px-6 h-[40px] hover:bg-[#1e2124] hover:text-white hover:border-[#1e2124] transition-colors cursor-pointer">
              Get Started
            </button>
